...
/**
 @author update gr4yscale
 // Update to allow deltas to influence rotation
 */
...
export default class OrbitControls extends EventDispatcher {
    constructor(object, domElement) {
        ...
        // gr4yscale hack, for delta based auto-rotation
        ...
        this.handleJoystickRotate = function(deltaX, deltaY) {
            ...
            rotateLeft(2 * Math.PI * this.rotateDelta.x / element.clientWidth * this.rotateSpeed);
            // rotating up and down along whole screen attempts to go 360, but limited to 180
            rotateUp(2 * Math.PI * this.rotateDelta.y / element.clientHeight * this.rotateSpeed);
        }
